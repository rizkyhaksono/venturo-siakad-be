...
class HomeroomTeachersController extends Controller
{
   ...
   */
  public function store(HomeroomTeachersRequest $request)
  {
    try {
   ...
   */
  public function show(HomeroomTeachersModel $class)
  {
    try {
      return response()->success([
        'status' => 'success',
   ...
   */
  public function update(HomeroomTeachersRequest $request, HomeroomTeachersModel $homeroomTeacher)
  {
    try {
      $validated = $request->validated();
   ...
   */
  public function destroy(HomeroomTeachersModel $homeroomTeacher)
  {
    try {
