...
return new class extends Migration
{
    ...
    {
        Schema::create('m_homeroom_teachers', function (Blueprint $table) {
            ...
            $table->foreign('study_year_id')->references('id')->on('m_study_years')->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('m_homeroom_teachers');
    }
};
