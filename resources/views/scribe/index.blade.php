...
maka akan menampilkan HTTP 404</a>
                                ...
                                <a href="#endpoints-POSTapi-v1-admin-logout">Logout user (revoke token)</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-admin-users-me">
                                <a href="#endpoints-GETapi-v1-admin-users-me">Get authenticated user details</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-admin-users">
                                <a href="#endpoints-GETapi-v1-admin-users">Display a listing of the resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-GETapi-v1-admin-users--id-">
                                <a href="#endpoints-GETapi-v1-admin-users--id-">Display the specified resource.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-admin-users--id-">
                                <a href="#endpoints-PUTapi-v1-admin-users--id-">Update authenticated user details</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-admin-users--id-">
                                <a href="#endpoints-DELETEapi-v1-admin-users--id-">Delete authenticated user account</a>
                            </li>
                                ...
                                <a href="#endpoints-GETapi-v1-admin-classes--id-">Display the specified class.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-v1-admin-classes--id-">
                                <a href="#endpoints-PUTapi-v1-admin-classes--id-">Update the specified class.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-DELETEapi-v1-admin-classes--id-">
                                <a href="#endpoints-DELETEapi-v1-admin-classes--id-">Remove the specified class (soft delete).</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-classes--id--restore">
                                <a href="#endpoints-POSTapi-v1-admin-classes--id--restore">Restore a soft-deleted class.</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-admin-class-histories--id-">Remove the specified class history.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-class-histories--id--restore">
                                <a href="#endpoints-POSTapi-v1-admin-class-histories--id--restore">Restore the specified class history.</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-admin-homeroom-teachers--id-">Remove the specified homeroom teacher.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-homeroom-teachers--id--restore">
                                <a href="#endpoints-POSTapi-v1-admin-homeroom-teachers--id--restore">Restore a soft-deleted homeroom teacher.</a>
                            </li>
                                ...
                                <a href="#endpoints-POSTapi-v1-admin-students--id--restore">Restore the specified student.</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-admin-study-years--id-">Remove the specified study year from storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-study-years--id--restore">
                                <a href="#endpoints-POSTapi-v1-admin-study-years--id--restore">Restore the specified study year.</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-admin-subject-hours--id-">Remove the specified resource from storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-subject-hours--id--restore">
                                <a href="#endpoints-POSTapi-v1-admin-subject-hours--id--restore">Restore the specified resource from storage.</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-admin-subject-schedules--id-">Remove the specified resource from storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-subject-schedules--id--restore">
                                <a href="#endpoints-POSTapi-v1-admin-subject-schedules--id--restore">Restore the specified resource in storage.</a>
                            </li>
                                ...
                                <a href="#endpoints-DELETEapi-v1-admin-subjects--id-">Remove the specified resource from storage.</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-v1-admin-subjects--id--restore">
                                <a href="#endpoints-POSTapi-v1-admin-subjects--id--restore">Restore the specified resource from storage.</a>
                            </li>
...
<div class="bash-example">
    ...
    --form "photo=@C:\Users\mrizk\AppData\Local\Temp\php33EF.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\mrizk\AppData\Local\Temp\php33EF.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-logout">Logout user (revoke token)</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-admin-users-me">Get authenticated user details</h2>
...
<span id="example-requests-GETapi-v1-admin-users-me">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/admin/users/me" \
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "username=vmqeopfuudtdsufvyvddq"\
    --form "password=OP&gt;@;4"\
    ...
    --form "role=consequatur"\
    --form "phone_number=49766366662210"\
    --form "photo=@C:\Users\mrizk\AppData\Local\Temp\php3400.tmp" </code></pre></div>


<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/admin/users/me"
);
...
<span id="example-responses-GETapi-v1-admin-users-me">
            <blockquote>
...
<span id="execution-results-GETapi-v1-admin-users-me" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-v1-admin-users-me"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-v1-admin-users-me"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-v1-admin-users-me" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-v1-admin-users-me">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-v1-admin-users-me" data-method="GET"
      data-path="api/v1/admin/users/me"
      data-authed="0"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-v1-admin-users-me', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-v1-admin-users-me"
                    onclick="tryItOut('GETapi-v1-admin-users-me');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-v1-admin-users-me"
                    onclick="cancelTryOut('GETapi-v1-admin-users-me');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-v1-admin-users-me"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/v1/admin/users/me</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-v1-admin-users-me"
               value="multipart/form-data"
               data-component="header">
    <br>
<p>Example: <code>multipart/form-data</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-v1-admin-users-me"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="username"                data-endpoint="GETapi-v1-admin-users-me"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="GETapi-v1-admin-users-me"
               value="OP>@;4"
               data-component="body">
    <br>
<p>Must be at least 6 characters. Example: <code>OP&gt;@;4</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="GETapi-v1-admin-users-me"
               value="kacey94@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>kacey94@example.org</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="role"                data-endpoint="GETapi-v1-admin-users-me"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the m_user_roles table. Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="photo"                data-endpoint="GETapi-v1-admin-users-me"
               value=""
               data-component="body">
    <br>
<p>Must be a file. Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\mrizk\AppData\Local\Temp\php3400.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>phone_number</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="phone_number"                data-endpoint="GETapi-v1-admin-users-me"
               value="49766366662210"
               data-component="body">
    <br>
<p>Must be between 8 and 15 digits. Example: <code>49766366662210</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-admin-users">Display a listing of the resource.</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-admin-users--id-">Display the specified resource.</h2>
...
<p>The ID of the user. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-admin-users--id-">Update authenticated user details</h2>
...
<div class="bash-example">
    ...
    --form "role=consequatur"\
    --form "phone_number=49766366662210"\
    --form "photo=@C:\Users\mrizk\AppData\Local\Temp\php34DC.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a file. Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\mrizk\AppData\Local\Temp\php34DC.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>phone_number</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>Must be between 8 and 15 digits. Example: <code>49766366662210</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-admin-users--id-">Delete authenticated user account</h2>
...
<div class="bash-example">
    ...
    --form "role=consequatur"\
    --form "phone_number=49766366662210"\
    --form "photo=@C:\Users\mrizk\AppData\Local\Temp\php34DD.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="username"                data-endpoint="DELETEapi-v1-admin-users--id-"
               value="vmqeopfuudtdsufvyvddq"
               data-component="body">
    <br>
<p>Must not be greater than 255 characters. Example: <code>vmqeopfuudtdsufvyvddq</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="password"                data-endpoint="DELETEapi-v1-admin-users--id-"
               value="OP>@;4"
               data-component="body">
    <br>
<p>Must be at least 6 characters. Example: <code>OP&gt;@;4</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="DELETEapi-v1-admin-users--id-"
               value="kacey94@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>kacey94@example.org</code></p>
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="role"                data-endpoint="DELETEapi-v1-admin-users--id-"
               value="consequatur"
               data-component="body">
    <br>
<p>The <code>id</code> of an existing record in the m_user_roles table. Example: <code>consequatur</code></p>
...
<i>optional</i> &nbsp;
                <input type="file" style="display: none"
                              name="photo"                data-endpoint="DELETEapi-v1-admin-users--id-"
               value=""
               data-component="body">
    <br>
<p>Must be a file. Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\mrizk\AppData\Local\Temp\php34DD.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>phone_number</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
                              name="phone_number"                data-endpoint="DELETEapi-v1-admin-users--id-"
               value="49766366662210"
               data-component="body">
    <br>
<p>Must be between 8 and 15 digits. Example: <code>49766366662210</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_users table. Example: <code>66529e01-d113-3473-8d6f-9e11e09332ea</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>The <code>id</code> of an existing record in the study_years table. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-GETapi-v1-admin-classes--id-">Display the specified class.</h2>
...
<p>The ID of the class. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-v1-admin-classes--id-">Update the specified class.</h2>
...
<p>The <code>id</code> of an existing record in the study_years table. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-admin-classes--id-">Remove the specified class (soft delete).</h2>
...
<p>The ID of the class. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-classes--id--restore">Restore a soft-deleted class.</h2>
...
<span id="example-requests-POSTapi-v1-admin-classes--id--restore">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/admin/classes/consequatur/restore" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-admin-classes--id--restore">
</span>
<span id="execution-results-POSTapi-v1-admin-classes--id--restore" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-admin-classes--id--restore"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-admin-classes--id--restore"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-admin-classes--id--restore" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-admin-classes--id--restore">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-admin-classes--id--restore" data-method="POST"
      data-path="api/v1/admin/classes/{id}/restore"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-admin-classes--id--restore', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-admin-classes--id--restore"
                    onclick="tryItOut('POSTapi-v1-admin-classes--id--restore');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-admin-classes--id--restore"
                    onclick="cancelTryOut('POSTapi-v1-admin-classes--id--restore');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-admin-classes--id--restore"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/admin/classes/{id}/restore</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-admin-classes--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-admin-classes--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-admin-classes--id--restore"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the class. Example: <code>consequatur</code></p>
...
<p>The ID of the class history. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-class-histories--id--restore">Restore the specified class history.</h2>
...
<span id="example-requests-POSTapi-v1-admin-class-histories--id--restore">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/admin/class-histories/consequatur/restore" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-admin-class-histories--id--restore">
</span>
<span id="execution-results-POSTapi-v1-admin-class-histories--id--restore" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-admin-class-histories--id--restore"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-admin-class-histories--id--restore"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-admin-class-histories--id--restore" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-admin-class-histories--id--restore">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-admin-class-histories--id--restore" data-method="POST"
      data-path="api/v1/admin/class-histories/{id}/restore"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-admin-class-histories--id--restore', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-admin-class-histories--id--restore"
                    onclick="tryItOut('POSTapi-v1-admin-class-histories--id--restore');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-admin-class-histories--id--restore"
                    onclick="cancelTryOut('POSTapi-v1-admin-class-histories--id--restore');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-admin-class-histories--id--restore"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/admin/class-histories/{id}/restore</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-admin-class-histories--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-admin-class-histories--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-admin-class-histories--id--restore"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the class history. Example: <code>consequatur</code></p>
...
<p>The ID of the homeroom teacher. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-homeroom-teachers--id--restore">Restore a soft-deleted homeroom teacher.</h2>
...
<span id="example-requests-POSTapi-v1-admin-homeroom-teachers--id--restore">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/admin/homeroom-teachers/consequatur/restore" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-admin-homeroom-teachers--id--restore">
</span>
<span id="execution-results-POSTapi-v1-admin-homeroom-teachers--id--restore" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-admin-homeroom-teachers--id--restore"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-admin-homeroom-teachers--id--restore"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-admin-homeroom-teachers--id--restore" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-admin-homeroom-teachers--id--restore">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-admin-homeroom-teachers--id--restore" data-method="POST"
      data-path="api/v1/admin/homeroom-teachers/{id}/restore"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-admin-homeroom-teachers--id--restore', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-admin-homeroom-teachers--id--restore"
                    onclick="tryItOut('POSTapi-v1-admin-homeroom-teachers--id--restore');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-admin-homeroom-teachers--id--restore"
                    onclick="cancelTryOut('POSTapi-v1-admin-homeroom-teachers--id--restore');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-admin-homeroom-teachers--id--restore"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/admin/homeroom-teachers/{id}/restore</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-admin-homeroom-teachers--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-admin-homeroom-teachers--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-admin-homeroom-teachers--id--restore"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the homeroom teacher. Example: <code>consequatur</code></p>
...
<div class="bash-example">
    ...
    \"birth_date\": \"2025-03-29T09:15:46\",
...
<i>optional</i> &nbsp;
               ...
               value="2025-03-29T09:15:46"
               data-component="body">
    <br>
<p>Must be a valid date. Example: <code>2025-03-29T09:15:46</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>The ID of the student. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-students--id--restore">Restore the specified student.</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/admin/students/consequatur/restore" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/admin/study-years/9e8aaa81-03a5-4748-9120-c1fbf82214b9" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/admin/study-years/9e8aaa81-03a5-4748-9120-c1fbf82214b9"
);
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="9e8aaa81-03a5-4748-9120-c1fbf82214b9"
               data-component="url">
    <br>
<p>The ID of the study year. Example: <code>9e8aaa81-03a5-4748-9120-c1fbf82214b9</code></p>
            </div>
                    </form>
...
<p>The ID of the study year. Example: <code>9e8aaa81-03a5-4748-9120-c1fbf82214b9</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-study-years--id--restore">Restore the specified study year.</h2>
...
<span id="example-requests-POSTapi-v1-admin-study-years--id--restore">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/admin/study-years/consequatur/restore" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-admin-study-years--id--restore">
</span>
<span id="execution-results-POSTapi-v1-admin-study-years--id--restore" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-admin-study-years--id--restore"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-admin-study-years--id--restore"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-admin-study-years--id--restore" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-admin-study-years--id--restore">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-admin-study-years--id--restore" data-method="POST"
      data-path="api/v1/admin/study-years/{id}/restore"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-admin-study-years--id--restore', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-admin-study-years--id--restore"
                    onclick="tryItOut('POSTapi-v1-admin-study-years--id--restore');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-admin-study-years--id--restore"
                    onclick="cancelTryOut('POSTapi-v1-admin-study-years--id--restore');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-admin-study-years--id--restore"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/admin/study-years/{id}/restore</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-admin-study-years--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-admin-study-years--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-admin-study-years--id--restore"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the study year. Example: <code>consequatur</code></p>
            </div>
                    </form>
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               step="any"               name="hours"                data-endpoint="POSTapi-v1-admin-subject-hours"
               value="73"
               data-component="body">
    <br>
...
<small>integer</small>&nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="hours"                data-endpoint="PUTapi-v1-admin-subject-hours--id-"
               value="73"
               data-component="body">
    <br>
<p>Must be at least 1. Example: <code>73</code></p>
...
<p>The ID of the subject hour. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-subject-hours--id--restore">Restore the specified resource from storage.</h2>
...
<span id="example-requests-POSTapi-v1-admin-subject-hours--id--restore">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/admin/subject-hours/consequatur/restore" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-admin-subject-hours--id--restore">
</span>
<span id="execution-results-POSTapi-v1-admin-subject-hours--id--restore" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-admin-subject-hours--id--restore"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-admin-subject-hours--id--restore"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-admin-subject-hours--id--restore" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-admin-subject-hours--id--restore">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-admin-subject-hours--id--restore" data-method="POST"
      data-path="api/v1/admin/subject-hours/{id}/restore"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-admin-subject-hours--id--restore', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-admin-subject-hours--id--restore"
                    onclick="tryItOut('POSTapi-v1-admin-subject-hours--id--restore');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-admin-subject-hours--id--restore"
                    onclick="cancelTryOut('POSTapi-v1-admin-subject-hours--id--restore');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-admin-subject-hours--id--restore"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/admin/subject-hours/{id}/restore</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-admin-subject-hours--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-admin-subject-hours--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-admin-subject-hours--id--restore"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the subject hour. Example: <code>consequatur</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_classes table. Example: <code>66529e01-d113-3473-8d6f-9e11e09332ea</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_subjects table. Example: <code>fa010f60-df29-3f05-8bc7-bed48f550d13</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>teacher_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_teachers table. Example: <code>57357f37-0ea3-38e5-8a6c-9de9d06e75fd</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_subject_hours table. Example: <code>c2cdda66-81e5-3060-a4eb-049b4a810d76</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>The ID of the subject schedule. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-subject-schedules--id--restore">Restore the specified resource in storage.</h2>
...
<span id="example-requests-POSTapi-v1-admin-subject-schedules--id--restore">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/admin/subject-schedules/consequatur/restore" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-admin-subject-schedules--id--restore">
</span>
<span id="execution-results-POSTapi-v1-admin-subject-schedules--id--restore" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-admin-subject-schedules--id--restore"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-admin-subject-schedules--id--restore"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-admin-subject-schedules--id--restore" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-admin-subject-schedules--id--restore">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-admin-subject-schedules--id--restore" data-method="POST"
      data-path="api/v1/admin/subject-schedules/{id}/restore"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-admin-subject-schedules--id--restore', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-admin-subject-schedules--id--restore"
                    onclick="tryItOut('POSTapi-v1-admin-subject-schedules--id--restore');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-admin-subject-schedules--id--restore"
                    onclick="cancelTryOut('POSTapi-v1-admin-subject-schedules--id--restore');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-admin-subject-schedules--id--restore"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/admin/subject-schedules/{id}/restore</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-admin-subject-schedules--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-admin-subject-schedules--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-admin-subject-schedules--id--restore"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the subject schedule. Example: <code>consequatur</code></p>
...
<div class="bash-example">
    ...
    \"class_id\": \"1915c795-5d1c-3def-965b-5abe034dd150\",
    \"teacher_id\": \"d63469cd-6701-3555-a16b-fc9764100c9a\"
}"
</code></pre></div>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="study_year_id"                data-endpoint="POSTapi-v1-admin-subjects"
               value="462ee709-6d9f-345a-95e6-76f833111fb8"
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_study_years table. Example: <code>462ee709-6d9f-345a-95e6-76f833111fb8</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>class_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="class_id"                data-endpoint="POSTapi-v1-admin-subjects"
               value="1915c795-5d1c-3def-965b-5abe034dd150"
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_classes table. Example: <code>1915c795-5d1c-3def-965b-5abe034dd150</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>teacher_id</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="teacher_id"                data-endpoint="POSTapi-v1-admin-subjects"
               value="d63469cd-6701-3555-a16b-fc9764100c9a"
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_teachers table. Example: <code>d63469cd-6701-3555-a16b-fc9764100c9a</code></p>
        </div>
        </form>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="study_year_id"                data-endpoint="PUTapi-v1-admin-subjects--id-"
               value="462ee709-6d9f-345a-95e6-76f833111fb8"
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_study_years table. Example: <code>462ee709-6d9f-345a-95e6-76f833111fb8</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="class_id"                data-endpoint="PUTapi-v1-admin-subjects--id-"
               value="1915c795-5d1c-3def-965b-5abe034dd150"
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_classes table. Example: <code>1915c795-5d1c-3def-965b-5abe034dd150</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="teacher_id"                data-endpoint="PUTapi-v1-admin-subjects--id-"
               value="d63469cd-6701-3555-a16b-fc9764100c9a"
               data-component="body">
    <br>
<p>Must be a valid UUID.  The <code>id</code> of an existing record in the m_teachers table. Example: <code>d63469cd-6701-3555-a16b-fc9764100c9a</code></p>
...
<p>The ID of the subject. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-v1-admin-subjects--id--restore">Restore the specified resource from storage.</h2>
...
<span id="example-requests-POSTapi-v1-admin-subjects--id--restore">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost/api/v1/admin/subjects/consequatur/restore" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-v1-admin-subjects--id--restore">
</span>
<span id="execution-results-POSTapi-v1-admin-subjects--id--restore" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-admin-subjects--id--restore"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-admin-subjects--id--restore"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-admin-subjects--id--restore" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-admin-subjects--id--restore">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-admin-subjects--id--restore" data-method="POST"
      data-path="api/v1/admin/subjects/{id}/restore"
      data-authed="0"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-admin-subjects--id--restore', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-admin-subjects--id--restore"
                    onclick="tryItOut('POSTapi-v1-admin-subjects--id--restore');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-admin-subjects--id--restore"
                    onclick="cancelTryOut('POSTapi-v1-admin-subjects--id--restore');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-admin-subjects--id--restore"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/admin/subjects/{id}/restore</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-admin-subjects--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-admin-subjects--id--restore"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="POSTapi-v1-admin-subjects--id--restore"
               value="consequatur"
               data-component="url">
    <br>
<p>The ID of the subject. Example: <code>consequatur</code></p>
